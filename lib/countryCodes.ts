// ISO 3166-1 numeric (zero-padded, 3-digit) → { alpha2, name }
// Matches the numeric IDs in world-atlas countries-110m.json
export const countryCodes: Record<string, { alpha2: string; name: string }> = {
  ...
  "178": { alpha2: "CG", name: "Republic of the Congo" },
